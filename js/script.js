...
$(document).ready(function() {
    ...
    $( "#radio" ).buttonset();
	  ...
	  $( "#radio" ).change(function () {
	    var str = "";
	    $( "input[name='guest']:checked" ).each(function() {
	      str = $(this).val();
	    });
	    switch (str) {
            case '2':
				if ($('div').is('#Guestname1')) {
                    $('#Guestname3').remove();
					$('#Guestname2').remove();
					$('#Guestname1').remove();
					$('#radio').after('<div id="Guestname1" class="form-group guestName"> <label for="guest1name">Name of Guest</label> <input type="text" class="form-control ajax-input" id="guest1name" placeholder=""  data-output-label="Name Guest 1"> </div>');
                }else{
					$('#radio').after('<div id="Guestname1" class="form-group guestName"> <label for="guest1name">Name of Guest</label> <input type="text" class="form-control ajax-input" id="guest1name" placeholder=""  data-output-label="Name Guest 1"> </div>');
				}
				break;
			/*case '3':
				if ($('div').is('#Guestname1')) {
                    ...
                    $('#Guestname2').remove();
					$('#Guestname1').remove();
					$('#radio').after('<div id="Guestname2" class="form-group guestName"> <label for="guest1name">Name of Guest 2</label> <input type="text" class="form-control ajax-input" id="guest2name" placeholder=""  data-output-label="Name Guest 2"> </div>');
					$('#radio').after('<div id="Guestname1" class="form-group guestName"> <label for="guest1name">Name of Guest</label> <input type="text" class="form-control ajax-input" id="guest1name" placeholder=""  data-output-label="Name Guest 1"> </div>');
                }else{
					$('#radio').after('<div id="Guestname2" class="form-group guestName"> <label for="guest1name">Name of Guest 2</label> <input type="text" class="form-control ajax-input" id="guest2name" placeholder=""  data-output-label="Name Guest 2"> </div>');
					$('#radio').after('<div id="Guestname1" class="form-group guestName"> <label for="guest1name">Name of Guest</label> <input type="text" class="form-control ajax-input" id="guest1name" placeholder=""  data-output-label="Name Guest 1"> </div>');
			...
			case '4':
				if ($('div').is('#Guestname1')) {
                    ...
                    $('#Guestname2').remove();
					$('#Guestname3').remove();
					$('#radio').after('<div id="Guestname3" class="form-group guestName"> <label for="guest1name">Name of Guest 3</label> <input type="text" class="form-control ajax-input" id="guest3name" placeholder="" data-output-label="Name Guest 3"> </div>');
					$('#radio').after('<div id="Guestname2" class="form-group guestName"> <label for="guest1name">Name of Guest 2</label> <input type="text" class="form-control ajax-input" id="guest2name" placeholder="" data-output-label="Name Guest 2"> </div>');
					$('#radio').after('<div id="Guestname1" class="form-group guestName"> <label for="guest1name">Name of Guest</label> <input type="text" class="form-control ajax-input" id="guest1name" placeholder="" data-output-label="Name Guest 1"> </div>');
                }else{
					$('#radio').after('<div id="Guestname3" class="form-group guestName"> <label for="guest1name">Name of Guest 3</label> <input type="text" class="form-control ajax-input" id="guest3name" placeholder="" data-output-label="Name Guest 3"> </div>');
	...
	function windowSize() {
        if($(window).width() <= '480'){
		$('#slide-image1').css("background-position","50% 0%");
		$('#slide-image2').css("background-position","20% 42.9px");
		$('#slide-image3').css("background-position","80% 0");
		$('#slide-image4').css({"background-position":"39% 51.9px", "background-size":"110% 100%"});
		$('#slide-image5').css("background-position","left 35% top 0%");
		$('#slide-image8').css("background-position","84% 130.1px");
	}else{
		$('#slide-image6').css("background-position","0 200px");
		$('#slide-image8').css("background-position","84% 350px");
	}
    }

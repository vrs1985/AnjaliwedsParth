	...
	function initialize() {
		...
		//=======================================================================================
  		var mapOptions = {
    		...
    		center: new google.maps.LatLng(42.053810, -88.019317),
			panControl: true,
  			zoomControl: true,
  			mapTypeControl: true,
  			//scaleControl: false,
		...
		var marker1 = new MarkerWithLabel({
       		position: new google.maps.LatLng(42.053810, -88.019317),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
		...
		var marker2 = new MarkerWithLabel({
       		position: new google.maps.LatLng(42.045919, -87.984905),
       		draggable: false,
       		raiseOnDrag: false,
       		icon: ' ',
       		map: map, 
         	labelContent: '<div class="de-icon circle small-size" style="background-color:#fff; border:1px solid #0d9a48"><i class="de-icon-home-1" style="color:#0d9a48"></i></div>',
